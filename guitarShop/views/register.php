...
<meta name="description" content="A Clean and fully responsive eCommerce Html Template for online store.">

<!-- Stylesheets
============================================= -->
<link rel="stylesheet" type="text/css" href="/bigshop-2/js/bootstrap/css/bootstrap.min.css" />
<link rel="stylesheet" type="text/css" href="/bigshop-2/css/font-awesome/css/font-awesome.min.css" />
<link rel="stylesheet" type="text/css" href="/bigshop-2/css/stylesheet.css" />
<link rel="stylesheet" type="text/css" href="/bigshop-2/css/owl.carousel.css" />
<link rel="stylesheet" type="text/css" href="/bigshop-2/css/owl.transitions.css" />
<link rel="stylesheet" type="text/css" href="/bigshop-2/css/responsive.css" />
<link rel="stylesheet" type="text/css" href="/bigshop-2/css/stylesheet-skin2.css" />
...
<div id="header">
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td><p>This is a CMS block edited from theme admin panel. You can insert any content (HTML, Text, Images) Here. Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                  <p><a target="" href="#">Read More</a><br>
                                  </p></td>
                              </tr>
                            </tbody>
                          </table>
      ...
      <nav id="menu" class="navbar wide">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="mega-menu dropdown"> <a>Categories</a></span>
  <div class="dropdown-menu">
    <div class="column col-lg-2 col-md-3"> <a href="category.html">Desktops</a></span>
      <div>
        <ul>
          <li> <a href="category.html">PC</a> </li>
          <li> <a href="category.html">Mac</a> </li>
          <li> <a href="category.html">Sub Category</a> </li>
          <li> <a href="category.html">test 4</a> </li>
          <li> <a href="category.html">test 5</a> </li>
        </ul>
      </div>
    </div>
    <div class="column col-lg-2 col-md-3"> <a href="category.html">Laptops &amp; Notebooks</a></span>
      <div>
        <ul>
    ...
    <div class="column col-lg-2 col-md-3"> <a href="category.html">Components</a></span>
      <div>
        <ul>
          <li> <a href="category.html">Mice and Trackballs</a> </li>
          <li> <a href="category.html">Monitors <span class="fa fa-caret-right"></span></a></span>
    ...
    <div class="column col-lg-2 col-md-3"> <a href="category.html">Phones &amp; PDAs</a></span>
      <div>
        <ul>
    ...
    <div class="column col-lg-2 col-md-3"> <a href="category.html">Cameras</a></span>
      <div>
        <ul>
          <li> <a href="category.html">New Category</a> </li>
          <li> <a href="category.html">Sub Category</a> </li>
    ...
    <div class="column col-lg-2 col-md-3"> <a href="category.html">MP3 Players</a></span>
      <div>
        <ul>
          <li> <a href="category.html">test 17</a> </li>
          <li> <a href="category.html">test 18</a> </li>
          <li> <a href="category.html">test 19</a> </li>
          <li> <a href="category.html">test 20 <span class="fa fa-caret-right"></span></a></span>
            <div class="dropdown-menu">
              <ul>
  ...
  <div class="dropdown-menu">
    <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"> <a href="#"><img src="image/no_image_60x60.jpg" title="Apple" alt="Apple"></a> <a href="#">Apple</a> </div>
    <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"> <a href="#"><img src="image/no_image_60x60.jpg" title="Burgerking" alt="Burgerking"></a> <a href="#">Burgerking</a> </div>
    <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"> <a href="#"><img src="image/no_image_60x60.jpg" title="Canon" alt="Canon"></a> <a href="#">Canon</a> </div>
    <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"> <a href="#"><img src="image/no_image_60x60.jpg" title="Dell" alt="Dell"></a> <a href="#">Dell</a> </div>
    <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"> <a href="#"><img src="image/no_image_60x60.jpg" title="Palm" alt="Palm"></a> <a href="#">Palm</a> </div>
    <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"> <a href="#"><img src="image/no_image_60x60.jpg" title="Sony" alt="Sony"></a> <a href="#">Sony</a> </div>
  </div>
</li>            
    ...
    ============================================= -->
      ...
      <div class="row">
        ...
        <div class="col-sm-9" id="content">
          ...
          <form class="form-horizontal" action="/?ctrl=account&action=register" method="POST">
            <fieldset id="account">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="tel" class="form-control" id="input-telephone" placeholder="Telephone" value="" name="phonenumber">
                </div>
              </div>
    ...
    <div class="fpart-second">
      <div class="container">
        <div id="powered">
          ...
          ============================================= -->
            <div class="col-md-4">
            <div class="payments_types"> <a href="#" target="_blank"> <img data-toggle="tooltip" src="image/payment/payment_paypal.png" alt="paypal" title="PayPal"></a> <a href="#" target="_blank"> <img data-toggle="tooltip" src="image/payment/payment_american.png" alt="american-express" title="American Express"></a> <a href="#" target="_blank"> <img data-toggle="tooltip" src="image/payment/payment_2checkout.png" alt="2checkout" title="2checkout"></a> <a href="#" target="_blank"> <img data-toggle="tooltip" src="image/payment/payment_maestro.png" alt="maestro" title="Maestro"></a> <a href="#" target="_blank"> <img data-toggle="tooltip" src="image/payment/payment_discover.png" alt="discover" title="Discover"></a></div>              
            </div><!--Payments Types End-->
            
            <!-- Payments Types
            ============================================= -->
            <div class="powered_text pull-left flip col-md-4"> Bigshop Template © 2017, Template By HarnishDesign </div>
...
============================================= -->
  ...
  </div><!-- Facebook Side Block End -->
  
  <!-- Twitter Side Block
  ============================================= -->
  <div id="twitter_footer" class="twit-right sort-order-2">
    <div class="twitter_icon"><i class="fa fa-twitter"></i></div>
    <a class="twitter-timeline" href="https://twitter.com/" data-chrome="nofooter transparent" data-theme="light" data-related="twitterapi,twitter" data-aria-polite="assertive" data-widget-id="347621595801608192">Tweets by @</a>
    <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
  </div><!-- Twitter Side Block End -->
...
<!-- JavaScripts
  ============================================= -->
<script type="/text/javascript" src="/bigshop-2/js/jquery-2.1.1.min.js"></script>
<script type="/text/javascript" src="/bigshop-2/js/bootstrap/js/bootstrap.min.js"></script>
<script type="/text/javascript" src="/bigshop-2/js/jquery.easing-1.3.min.js"></script>
<script type="/text/javascript" src="/bigshop-2/js/jquery.dcjqaccordion.min.js"></script>
<script type="/text/javascript" src="/bigshop-2/js/owl.carousel.min.js"></script>
<script type="/text/javascript" src="/bigshop-2/js/custom.js"></script>
<!-- JavaScripts End-->
